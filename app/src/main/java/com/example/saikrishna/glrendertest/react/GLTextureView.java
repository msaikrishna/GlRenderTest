...
package com.example.saikrishna.glrendertest.react;
...
public class GLTextureView
    ...
    private ExoPlayerView.OnSurfaceCreatedCallBack onSurfaceCreatedCallBack;
    ...
    SurfaceTexture alphaTexture = null;
    /**
    ...
    public void setAlphaColorForRenderer(int color) {
        if (renderer != null) {
            renderer.setAlphaColor(color);
        }
    }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        if(newSurfaceTextureListener != null) {
            newSurfaceTextureListener.onSurfaceTextureUpdated(surface);
        } else {
            requestRender();
        }
    }

    public void setOnSurfaceCreatedCallBack(ExoPlayerView.OnSurfaceCreatedCallBack onSurfaceCreatedCallBack) {
